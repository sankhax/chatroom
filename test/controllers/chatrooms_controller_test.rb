...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference("Chatroom.count") do
      post chatrooms_url, params: { chatroom: { message: @chatroom.message, room: @chatroom.room, sender: @chatroom.sender } }, as: :json
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { message: @chatroom.message, room: @chatroom.room, sender: @chatroom.sender } }, as: :json
    assert_response :success
  end
